...
create memory table T_MESSAGE ( MSG_ID_C varchar(36) not null, MSG_USERNAME_C varchar(50) not null, MSG_EMAIL_C varchar(60) not null, MSG_PASSWORD_C varchar(60) not null, MSG_CREATEDATE_D datetime not null, primary key (MSG_ID_C) );
